    ...
    $.ajax({
        ...
        success: function(data){
            if (data.name == ''){
                ...
                $('#welcome em').text(data.name).show()
                $('#login').hide()
            }
            $.each(data.houses_data,function(index,elem){
                $('.swiper-wrapper').append(
                    $('<div>').attr('class','swiper-slide').append(
                        $('<a>').attr('href','/house/detail?id='+elem.id).append(
                            $('<img>').attr('src',elem.image),
                            $('<div>').attr('class','slide-title').text(elem.title)
                        )
                    )
                )
            })
            ...
            $.each(data.areas_data,function(index,elem){
                $('.area-list').append(
                    $('<a>').attr('href','#').attr('area-id',elem.id).text(elem.name)
                )
            })
